...
public class CloudPrinterProxy {
    /**
     * 易联云颁发给开发者的应用ID 非空值
     */
    ...
    private CloudPrinterProxy() {
    }

    private static class SingleMethods {
        private static final CloudPrinterProxy COCOS_MANGER = new CloudPrinterProxy();
    }

    public static final CloudPrinterProxy getInstance() {
